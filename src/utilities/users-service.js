...
export function checkToken() {
  ...
  // this is the users-api checkToken BTW
  return usersAPI.checkToken()
  // once promise is returned from users-api/send-request, we receive a string containing our expiration date
  .then(dateStr => new Date(dateStr)); // this returns a promise, which we convert into a Date() object
}
